...
// export const Item:React.FC<ItemThemeCardProps> = ({item}) => {
//   return (
//     <div
//       key={item.link}
//       className="hover:bg-(--color-accent-bg) rounded-lg transition-colors px-4 py-2 -mx-4"
//     >
...
//             />
//             <Text strong className="text-(--color-text-h)">
//               {item.tlg_channel}
//             </Text>
//           </Space>
...
//           rel="noopener noreferrer"
//           icon={<SendOutlined />}
//           className="p-0! h-auto! text-(--color-accent)! hover:opacity-80!"
//         >
//           Читать в Telegram
//         </Button>
//       </div>
